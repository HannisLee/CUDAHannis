...
def naive_vector_add(a: torch.Tensor, b: torch.Tensor):
    return a + b
...
def bench_shape(N: int, K: int):
    ...
    run_benchmark(lib.vector_add_f16, a, b, "f16", out)
    run_benchmark(lib.vector_add_f16x2, a, b, "f16x2", out)
    run_benchmark(lib.vector_add_f16x8, a, b, "f16x8", out)
    run_benchmark(lib.vector_add_f16x8_pack, a, b, "f16x8_pack", out)
    from vector_add_triton import vector_add_triton
    run_benchmark(vector_add_triton, a, b, "triton")
    run_benchmark(naive_vector_add, a, b, "torch")
