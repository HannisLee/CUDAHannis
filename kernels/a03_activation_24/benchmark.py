...
def bench_shape(*shape: int, dtype: torch.dtype = torch.float16):
    ...
    ref, _ = run_benchmark(activation_24_sparsity, x, "torch", warmup=3, iters=20)
    run_benchmark(lib.activation_24_sparsity_forward, x, "cuda", ref)
    run_benchmark(activation_24_triton_v1, x, "triton_v1", ref)
    run_benchmark(activation_24_triton_v2, x, "triton_v2", ref)
    run_benchmark(activation_24_triton_v6, x, "triton_v6", ref)
